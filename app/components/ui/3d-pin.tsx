  ...
  return (
      <>
          ...
          >
            ...
            >
              <div
                  ...
                  className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-white dark:bg-black border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden max-h-96"
              >
        ...
        >
          <ModalContent>
            {(onClose) => (
                <div className={"md:mt-24 md:flex md:space-x-5"}>
                  <Card className="hidden md:block max-w-full h-full">
                    <CardBody className="h-full space-y-2">
                      ...
                      <h3 className="max-w-xs text-center font-bold  text-base text-slate-800 dark:text-slate-100">
