...
export default function HeroComponent() {
  ...
  return (
    <>
      <div className="inset-0 h-screen w-screen bg-white dark:bg-black bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] z-10"></div>
      <BlurBallComponent className={'bg-[#3b82f6] left-[10%] md:left-[80%] top-[250px] z-20'}/>
      <Spline scene="https://prod.spline.design/bd6OMccTZXFXYKqw/scene.splinecode" className={'absolute flex justify-center z-10 top-[-50px] md:top-[-150px] h-[50px] w-[50px] spline'}/>
